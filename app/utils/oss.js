...
const IMG_REGION = 'img-cn-shenzhen';
const ACCESS_KEY_ID = 'LTAIfSQC06mLDZ8u';
const ACCESS_KEY_SECRET = 'xdZhVnDlKSdISH7MV1U6wJe3krYPkA';
const BUCKET_NAME = 'onehower';
const DOMAIN = 'http://onehower.oss-cn-shenzhen.aliyuncs.com/';
const module = {
  chat: 'chat',
  avatar: 'avatar',
  moments: 'moments',
